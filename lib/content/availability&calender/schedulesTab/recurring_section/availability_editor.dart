// lib\content\availability&calender\schedulesTab\recurring_section\availability_editor.dart
...
class _AvailabilityEditorState extends State<AvailabilityEditor> {
  ...
  void _copyToOtherDays(String sourceDay) async {
    ...
    if (selectedDays != null && selectedDays.isNotEmpty) {
      ...
      //   ),
      // );
      SnackbarHelper.showInfo(context, 'Copied to ${selectedDays.length} day(s)');
